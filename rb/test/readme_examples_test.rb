...
#      offline in seeded test mode (NycOpenDataSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "NycOpenData_sdk.rb")
  SDK_CLASS = "NycOpenDataSDK"
