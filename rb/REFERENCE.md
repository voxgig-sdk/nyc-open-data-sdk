# NycOpenData Ruby SDK Reference

Complete API reference for the NycOpenData Ruby SDK.
...
```ruby
require_relative 'nyc-open-data_sdk'
...
#### `NycOpenDataSDK.test(testopts = nil, sdkopts = nil)`
