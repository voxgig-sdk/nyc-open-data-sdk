...
AQL-driven CLI and REPL for the NycOpenData SDK. Positional arguments are
...
./nyc-open-data-cli load 1 catalog
./nyc-open-data-cli load '{id:1}' catalog
