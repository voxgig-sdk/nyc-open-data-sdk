...
func registerSDKWords(r *eng.Registry, client *sdk.NycOpenDataSDK) {
...
func runOp(client *sdk.NycOpenDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
