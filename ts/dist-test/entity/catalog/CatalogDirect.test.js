...
(0, node_test_1.describe)('CatalogDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.NycOpenDataSDK({
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.NycOpenDataSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['NYC_OPEN_DATA_TEST_CATALOG_ENTID'];
    ...
    const client = new __1.NycOpenDataSDK({
        base: 'http://localhost:8080',
