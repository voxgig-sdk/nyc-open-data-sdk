...
function envOverride(m) {
    if ('TRUE' === process.env.NYC_OPEN_DATA_TEST_LIVE ||
        'TRUE' === process.env.NYC_OPEN_DATA_TEST_OVERRIDE) {
    ...
    m.NYC_OPEN_DATA_TEST_EXPLAIN = process.env.NYC_OPEN_DATA_TEST_EXPLAIN || m.NYC_OPEN_DATA_TEST_EXPLAIN;
    return m;
}
