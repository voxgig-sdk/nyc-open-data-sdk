# NycOpenData TypeScript SDK Reference

Complete API reference for the NycOpenData TypeScript SDK.
...
```ts
new NycOpenDataSDK(options?: object)
```
...
#### `NycOpenDataSDK.test(testopts?, sdkopts?)`
...
**Returns:** `NycOpenDataSDK` instance in test mode.
...
Return the parent `NycOpenDataSDK` instance.
