...
func registerTools(server *mcp.Server, client *sdk.NycOpenDataSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "nyc-open-data_list",
		Description: "List records from NycOpenData. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "nyc-open-data_load",
		Description: "Load a single record from NycOpenData. " +
...
func runOp(client *sdk.NycOpenDataSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.NycOpenDataSDK, name string) (sdk.NycOpenDataEntity, error) {
