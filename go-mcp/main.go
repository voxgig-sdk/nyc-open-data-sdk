// Command NycOpenData-mcp is an MCP server exposing the NycOpenData
// SDK as MCP tools.
//
// Two tools are registered:
//
//	NycOpenData_list  — list records of an entity
//	NycOpenData_load  — load a single record of an entity
//
