...
// instead of `sdk.NewNycOpenDataSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *NycOpenDataSDK  { return NewNycOpenDataSDK(nil) }
func Test() *NycOpenDataSDK { return TestSDK(nil, nil) }
