# NycOpenData Golang SDK Reference

Complete API reference for the NycOpenData Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *NycOpenDataSDK`
...
#### `Catalog(data map[string]any) NycOpenDataEntity`
