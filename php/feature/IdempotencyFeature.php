...
// NycOpenData SDK idempotency feature
...
class NycOpenDataIdempotencyFeature extends NycOpenDataBaseFeature
{
    ...
    private function _mutating(NycOpenDataContext $ctx): bool
    {
