...
// NycOpenData SDK streaming feature
...
class NycOpenDataStreamingFeature extends NycOpenDataBaseFeature
{
    ...
    private function _iterate(NycOpenDataResult $result): \Generator
    {
    ...
    private function _streamable(NycOpenDataContext $ctx): bool
    {
