...
class NycOpenDataProxyFeature extends NycOpenDataBaseFeature
{
    ...
    public function init(NycOpenDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NycOpenDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
