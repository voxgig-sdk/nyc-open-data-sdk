...
// NycOpenData SDK clienttrack feature
...
class NycOpenDataClienttrackFeature extends NycOpenDataBaseFeature
{
    ...
    public function PostConstruct(NycOpenDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'NycOpenData-SDK';
