...
class NycOpenDataCacheFeature extends NycOpenDataBaseFeature
{
    ...
    private function _through(NycOpenDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
