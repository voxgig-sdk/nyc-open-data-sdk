# NycOpenData PHP SDK Reference

Complete API reference for the NycOpenData PHP SDK.
...
```php
require_once __DIR__ . '/nyc-open-data_sdk.php';
...
#### `NycOpenDataSDK::test($testopts = null, $sdkopts = null)`
