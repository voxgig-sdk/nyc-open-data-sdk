...
// NycOpenData SDK utility: graphql
//
...
class NycOpenDataGraphql
{
    ...
    // equivalent.
    public static function body(NycOpenDataContext $ctx): mixed
    {
    ...
    public static function errors(NycOpenDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
