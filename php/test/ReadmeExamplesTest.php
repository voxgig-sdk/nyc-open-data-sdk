...
// NycOpenData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NycOpenDataSDK::test)
...
{
    private const SDK_CLASS = 'NycOpenDataSDK';
    ...
    private const SDK_BASE = 'nycopendata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../nycopendata_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
