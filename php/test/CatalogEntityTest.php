...
class CatalogEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set NYCOPENDATA_TEST_CATALOG_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function catalog_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("NYCOPENDATA_TEST_CATALOG_ENTID");
