...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/nyc-open-data` | `npm install @voxgig-sdk/nyc-open-data` |
| Python | `voxgig-sdk-nyc-open-data` | `pip install voxgig-sdk-nyc-open-data` |
| PHP | `voxgig-sdk/nyc-open-data` | `composer require voxgig-sdk/nyc-open-data` |
| Golang | `github.com/voxgig-sdk/nyc-open-data-sdk/go` | `go get github.com/voxgig-sdk/nyc-open-data-sdk/go` |
| Ruby | `voxgig-sdk-nyc-open-data` | `gem install voxgig-sdk-nyc-open-data` |
| Lua | `voxgig-sdk-nyc-open-data` | `luarocks install voxgig-sdk-nyc-open-data` |
