...
function runner.env_override(m)
  local live = runner.getenv("NYC_OPEN_DATA_TEST_LIVE")
  local override = runner.getenv("NYC_OPEN_DATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NYC_OPEN_DATA_TEST_EXPLAIN")
