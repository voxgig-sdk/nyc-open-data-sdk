...
function runner.env_override(m)
  local live = runner.getenv("NYCOPENDATA_TEST_LIVE")
  local override = runner.getenv("NYCOPENDATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NYCOPENDATA_TEST_EXPLAIN")
