...
|---|---|---|
| `ts/` | @voxgig-sdk/nyc-open-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/nyc-open-data-sdk \
      --repository voxgig-sdk/nyc-open-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/nyc-open-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/nyc-open-data-sdk --id=<id>` removes it.
