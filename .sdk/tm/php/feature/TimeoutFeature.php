...
// NycOpenData SDK timeout feature
...
class NycOpenDataTimeoutFeature extends NycOpenDataBaseFeature
{
    ...
    private function _with_timeout(NycOpenDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NycOpenDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
