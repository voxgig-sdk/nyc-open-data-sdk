...
// NycOpenData SDK metrics feature
...
class NycOpenDataMetricsFeature extends NycOpenDataBaseFeature
{
    ...
    private function _record(NycOpenDataContext $ctx, bool $ok): void
    {
