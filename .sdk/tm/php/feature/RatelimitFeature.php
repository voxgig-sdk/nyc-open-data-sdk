...
// NycOpenData SDK ratelimit feature
...
class NycOpenDataRatelimitFeature extends NycOpenDataBaseFeature
{
    ...
    private function _acquire(NycOpenDataContext $ctx): void
    {
    ...
    private function _track(NycOpenDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
