...
// NycOpenData SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class NycOpenDataTestFeature extends NycOpenDataBaseFeature
{
    ...
    public function init(NycOpenDataContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (NycOpenDataContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = NycOpenDataParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (NycOpenDataContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(NycOpenDataContext $ctx, $op, $args): array
    {
