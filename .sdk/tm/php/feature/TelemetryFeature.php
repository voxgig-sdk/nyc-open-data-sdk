...
// NycOpenData SDK telemetry feature
...
class NycOpenDataTelemetryFeature extends NycOpenDataBaseFeature
{
    ...
    private function _close(NycOpenDataContext $ctx, bool $ok): void
    {
