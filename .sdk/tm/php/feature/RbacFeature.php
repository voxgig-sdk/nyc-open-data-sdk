...
class NycOpenDataRbacFeature extends NycOpenDataBaseFeature
{
    ...
    private function _required(NycOpenDataContext $ctx): ?string
    {
    ...
    private function _reject(NycOpenDataContext $ctx, string $required): void
    {
    ...
    private function _track(NycOpenDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
