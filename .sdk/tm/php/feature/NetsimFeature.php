...
// NycOpenData SDK netsim feature
...
class NycOpenDataNetsimFeature extends NycOpenDataBaseFeature
{
    ...
    private function _simulate(NycOpenDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NycOpenDataContext $ctx, array $applied): void
    {
        $client = $this->client;
