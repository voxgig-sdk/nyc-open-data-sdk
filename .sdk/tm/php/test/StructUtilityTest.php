...
// NycOpenData SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = NycOpenDataOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(NycOpenDataOmni::structfix($now, Struct::undef()))
                        !== json_encode(NycOpenDataOmni::structfix($val, Struct::undef()))) {
