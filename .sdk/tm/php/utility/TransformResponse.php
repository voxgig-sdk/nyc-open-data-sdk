...
// NycOpenData SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class NycOpenDataTransformResponse
{
    public static function call(NycOpenDataContext $ctx): mixed
    {
        ...
        $transform = NycOpenDataHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
