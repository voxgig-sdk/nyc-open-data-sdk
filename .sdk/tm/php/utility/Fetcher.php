...
// NycOpenData SDK utility: fetcher
...
class NycOpenDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NycOpenDataSDK/1.0)';
    ...
    public static function call(NycOpenDataContext $ctx, string $fullurl, array $fetchdef): array
    {
