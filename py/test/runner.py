...
class NycOpenDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NycOpenDataTestRunner.getenv("NYCOPENDATA_TEST_LIVE")
        override = NycOpenDataTestRunner.getenv("NYCOPENDATA_TEST_OVERRIDE")
        ...
        explain = NycOpenDataTestRunner.getenv("NYCOPENDATA_TEST_EXPLAIN")
