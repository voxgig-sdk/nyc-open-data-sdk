# NycOpenData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NycOpenDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NycOpenDataSDK(...) and NycOpenDataSDK.test(...) become
#      NycOpenDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "nycopendata_sdk"
_SDK_CLASS = "NycOpenDataSDK"
