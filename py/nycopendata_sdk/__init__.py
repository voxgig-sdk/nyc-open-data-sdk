...
from nycopendata_sdk.utility import register

# Load features
from nycopendata_sdk.feature.base_feature import NycOpenDataBaseFeature
from nycopendata_sdk.features import _has_feature, _make_feature
...
class NycOpenDataSDK:
    ...
    def get_utility(self):
        return NycOpenDataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NycOpenDataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Catalog(self, data=None) -> "CatalogEntity":
        ...
        from nycopendata_sdk.entity.catalog_entity import CatalogEntity
